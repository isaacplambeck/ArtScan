...
starter = cv2.imread('C:/seniorDesign/git/sddec23-18/test/assets/paper.png') #For Screenshots
image = cv2.imread('C:/seniorDesign/git/sddec23-18/test/assets/paper.png')
original = image.copy()
gray = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
canny = cv2.Canny(gray, 120, 255, 1)

corners = cv2.goodFeaturesToTrack(canny,4,0.5,60)
...
cv2.imshow('orignal', starter) #For Screenshots
